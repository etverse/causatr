...
probability weighting (IPW with a self-contained density-ratio engine), and
propensity score matching (via [MatchIt](https://kosukeimai.github.io/MatchIt/)).
When all three methods agree, you can be more confident in your findings — this
