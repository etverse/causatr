...
- **Nonlinear ordered policies** (e.g. a dose-escalation cap) need a flexible
  dose model that causatr's ICE does not yet expose, so they are not part of the
  public API (see `PHASE_22_ICE_ENHANCEMENTS.md` §3.7).
