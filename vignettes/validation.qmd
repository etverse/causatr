...
The AIPW engine is cross-validated against **`delicatessen`**
[@zivich2022delicatessen], a Python M-estimation library that implements the same stacked
estimating-equation sandwich for AIPW [@robins1994aipw].
