...
nocite: |
  @hernan_whatif, @little2019missing
---
...
variability and the between-imputation uncertainty, via Rubin's [-@rubin1987mi] rules
with Barnard-Rubin [-@barnard1999df] degrees of freedom. The per-imputation diagnostics
...
direction [@meng1994uncongenial; @bartlett2020bootstrap] — not reliably conservative.
`pool_method = "boot_mi"` [@vonhippel2020howmany] replaces Rubin's variance
...
the causal estimator stays consistent** [@bartlett2020bootstrap]. The single
most important way to keep it consistent is to **include the outcome `Y` as a
predictor in the imputation model** [@vanbuuren2018flexible, ch. 6]: omitting it
