...
| Binary (absorbing) | Continuous / Binary | `grace_period` / `carry_forward` (natural-history MTP) | ATE | Difference | Bootstrap / Sandwich | none / cens / ext | ✅ vs forward-MC truth (Díaz et al. 2026 §6); sandwich validated vs Python oracle |
