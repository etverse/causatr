...
**What's not yet supported.** Per-period `ipsi()` under longitudinal
IPW is rejected with a `_pending` classed error. Use
`estimator = "gcomp"` (ICE) for that scenario today.
