...
| Outcome | Treatment | Intervention | Variance | Weights | Status |
|---|---|---|---|---|---|
| Continuous | Binary | Static (always vs never) | Sandwich | none | ✅ Table 20.1 |
| Continuous | Binary | Static | Bootstrap | none | ✅ Table 20.1 |
| Continuous | Binary | Dynamic (rule on L) | Sandwich | none | ✅ |
| Continuous | Binary | Static | Sandwich + bootstrap | survey | ✅ |
| Continuous | Continuous | Shift / Scale / Threshold | Sandwich | none | ✅ (vs lmtp) |
| Continuous | Continuous | Shift | Bootstrap | none | ✅ (vs lmtp) |
| Continuous | Multivariate | Static / Shift | Sandwich | none | ✅ |
| Binary | Binary | Static / Dynamic | Sandwich / bootstrap | none | ✅ (3+ periods) |
| Binary | Binary | Static | Bootstrap (parallel) | none | ✅ |
| Continuous | Binary | Static | Sandwich | none + censoring | ✅ |
| — | Binary | ipsi(δ) | — | — | ⛔ rejected (Phase 4) |
| — | Binary | static / ATT | — | — | ⛔ rejected (ICE is ATE-only) |
