...
- `PHASE_*.md` — per-phase implementation guides in the project root. Completed: 2–6, 8–16. In progress: 17 (17a–17c shipped; 17d–17i pending). Pending: 18–23 (design docs).
